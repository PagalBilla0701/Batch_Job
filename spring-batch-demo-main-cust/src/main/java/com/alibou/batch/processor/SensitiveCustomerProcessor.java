...
public class SensitiveCustomerProcessor implements ItemProcessor<CustIndicator, CustIndicator> {
    ...
    public CustIndicator process(CustIndicator item) throws Exception {
        ...
        if (existing.isPresent()) {
            ...
            existingIndicator.setFSensitiveCust(item.getFSensitiveCust());
            ...
            item.setNSensitiveCustFileId(1);  // Static value for development
            return item;
        }
    }
}