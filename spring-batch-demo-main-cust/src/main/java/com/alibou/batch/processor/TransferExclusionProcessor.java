...
public class TransferExclusionProcessor implements ItemProcessor<CustIndicator, CustIndicator> {
    ...
    public CustIndicator process(CustIndicator item) throws Exception {
        ...
        if (existing.isPresent()) {
            ...
            existingIndicator.setFTransferExclusion(item.getFTransferExclusion());
            ...
            item.setNTransferExclusionFileId(1);  // Static value for development
            return item;
        }
    }
}