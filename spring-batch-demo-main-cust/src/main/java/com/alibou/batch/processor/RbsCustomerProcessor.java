...
public class RbsCustomerProcessor implements ItemProcessor<CustIndicator, CustIndicator> {
    ...
    public CustIndicator process(CustIndicator item) throws Exception {
        ...
        if (existing.isPresent()) {
            ...
            existingIndicator.setRbsCust(item.getRbsCust());
            ...
            item.setNRbsCustFileId(1);  // Static value for development
            return item;
        }
    }
}